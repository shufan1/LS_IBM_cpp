...
// placeholder value wherever ibm.flag_u/flag_v==1 (ghost cells --
...
// local to this function). ibm.flag_u/flag_v default to all-zero
// (LSIBMcoeffs.m isn't ported), so this is a no-op until real IBM
// geometry exists -- equivalent to a domain with no solid cells.
//
